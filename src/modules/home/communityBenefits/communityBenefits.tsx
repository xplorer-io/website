...
export const CommunityBenefits = () => {
  return (
    <section className="md:flex-col-2 mx-10 flex flex-col justify-center gap-10 lg:mx-14 lg:mt-8 lg:gap-12">
      ...
      <Button className="mb-8 mt-8 flex items-center gap-2 self-center dark:hover:bg-blue-500">
