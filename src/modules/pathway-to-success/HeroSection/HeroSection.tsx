...
const HeroSection = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: `url('https://raw.githubusercontent.com/xplorer-io/website-images-cdn/refs/heads/main/xplorers-website-images/pathway-to-success/pathway-to-success-banner.webp')`,
      }}
    >
